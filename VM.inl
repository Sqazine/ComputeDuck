...
#define RUN(type, ret, initializer)                                                                                                                                                                                                                                                                    \
    ...
    else if (frame.closure->function->parameterCount == 4)                                                                                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                                                                                  \
    ...
    else if (frame.closure->function->parameterCount == 5)                                                                                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                                                                                  \
    ...
    else if (frame.closure->function->parameterCount == 6)                                                                                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                                                                                  \
