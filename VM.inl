...
#define RUN(type, ret, initializer)                                                                                                                                                                                                                                                                    \
    ...
    {                                                                                                                                                                                                                                                                                                  \
        ...
        auto arg3 = *(frame.slot + 3);                                                                                                                                                                                                                                                                 \
        auto arg4 = *(frame.slot + 4);                                                                                                                                                                                                                                                                 \
        auto arg5 = *(frame.slot + 5);                                                                                                                                                                                                                                                                 \
        APPREGATE6(arg0, arg1, arg2, arg3, arg4, arg5, actualArg0, actualArg1, actualArg2, actualArg3, actualArg4, actualArg5, ret m_Jit->Run<type>(fnName, std::move(actualArg0), std::move(actualArg1), std::move(actualArg2), std::move(actualArg3), std::move(actualArg4), std::move(actualArg4))) \
    }                                                                                                                                                                                                                                                                                                  \
    else                                                                                                                                                                                                                                                                                               \
